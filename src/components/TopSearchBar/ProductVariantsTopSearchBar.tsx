...
import ProductVariantsToolbar from '../Toolbar/ProductVariantsToolbar';
...
const ProductVariantsTopSearchBar: React.FC<TopSearchBarProps> = ({
  btns,
  title,
  pagination,
  tools,
...
export default ProductVariantsTopSearchBar;
