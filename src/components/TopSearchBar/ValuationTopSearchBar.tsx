...
import ValuationToolbar from '../Toolbar/ValuationToolbar';
...
const ValuationTopSearchBar: React.FC<TopSearchBarProps> = ({
  btns,
  title,
  pagination,
  tools,
...
export default ValuationTopSearchBar;
